...
public class TrackingCadeteFragment extends Fragment {
    ...
    private void observarViewModel() {
        ...
        viewModel.getCardBackgroundColor().observe(getViewLifecycleOwner(), binding.cardEstadoPedido::setCardBackgroundColor);
        ...
        viewModel.getButtonBackgroundTint().observe(getViewLifecycleOwner(), binding.btnAbrirMapa::setBackgroundTintList);
        
        viewModel.getIconColorFilter().observe(getViewLifecycleOwner(), colorFilter -> 
            binding.imgEstadoIcon.setColorFilter(colorFilter.color, colorFilter.mode));
